...
def traffic():
    ...
    while (not a.empty or not b.empty or not c.empty or not d.empty or cross.driving_cars) and not error :
            ...
            if car.direction == Direction.LEFT:
                ...
                # if going right on a red check if there is incoming traffic every 3 seconds
                    ...
                    if safe:
                        ...
                        print("car " + car.name + " took a bad right turn, human error was introduced. This will lock the intersection!")
                        error = True
...
if __name__ == "__main__":
    print("Changing the number of cars to 100 per road...")
    print("human error is introduced, cars will not always wait 3 seconds at a red")
    print("when caught, simulation will terminate")
    traffic()